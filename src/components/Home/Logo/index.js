...
//         // .fromTo(outlineRef.current, { drawSVG:50}, { duration:5, drawSVG:10000})
        .to(solidRef.current, {opacity:1, duration: 2 })
        .to(outlineRef.current, {duration:2, opacity:0});
...
//     }, []);
    ...
    return(
        <div className='logo-container' ref={bgRef}>
            <img className='solid-logo' src = {LogoS} ref = {solidRef} alt="S"/>

            <Walkway
                svg = {
                    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="559pt" height="897pt" viewBox="0 0 559 897">
                    
                        <g transform="translate(0 475) scale(.1,-.1)" fill="none"  className='svg-container'>
                            <path id='outlineref' ref={outlineRef} d="m2930 4560 c-344 -16 -623 -85 -915 -228 -231 -114 -406 -241 -600
                            ...
                            -575 62 -130 183 -342 550 -326 566 11 11 446 277 454 278 4 1 33 -45 65
                            -101z"/>
                        </g>
                    </svg>
                    }
